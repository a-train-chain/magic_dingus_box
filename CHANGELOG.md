...
Pre-1.6 hardening pass: a multi-domain audit of the merged-in v1.5.x feature work surfaced 28 findings; 23 are addressed below across two commits, with 5 deferred as standalone tasks (GStreamer bus rework, RetroArch heredoc shell escaping, controller retry-after-cleanup, OTA rollback test coverage, manager.js inline-JS refactor).
