...
A Pi running an older version that runs OTA will see whatever is `/releases/latest` — currently **v1.6.0** — and jump straight there. No multi-hop sequencing required.
